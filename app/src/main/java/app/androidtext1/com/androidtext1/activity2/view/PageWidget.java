package app.androidtext1.com.androidtext1.activity2.view;
...
public class PageWidget extends View {
    ...
    boolean mIsRTandLB; // 是否属于右上左下 // for test
    ...
    public PointF getCross(PointF P1, PointF P2, PointF P3, PointF P4) {
        PointF CrossP = new PointF(); // 二元函数通式：y = ax + b
    ...
    private void calcPoints() {
        ...
        Log.i("hmg", "mBezierEnd2.x  " + mBezierEnd2.x + "  mBezierEnd2.y  "
                + mBezierEnd2.y); /* * mBeziervertex1.x 推导
    ...
    public void drawCurrentPageShadow(Canvas canvas) { //注：拖拽顶点的阴影，定位有问题，待修改~~
